...
from .views import index, resume, salle_attente, candidat_create, candidat_detail, candidat_valide, salle_user, amis, ligues, ligue, lancer_ligue, quitter_ligue, favoris, nouvel_ami, recherche_amis, retirer_ami, maj
